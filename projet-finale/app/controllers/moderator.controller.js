...
// 3ala5ater l'affichage mta3 les salles
...
exports.createSalle = async (req, res) => {
  try {
    // Na7i l'khata2 ken fama champs vide
...
// Badal info mta3 salle
exports.updateSalle = async (req, res) => {
  try {
    // Na7i lkhata2 ken fama champs vide
    if (!req.body.nom || !req.body.capacite) {
      return res.status(400).send({ message: "Le nom et la capacité sont requis" });
    }
...
// 3ala5ater l'affichage mta3 les réservations
...
exports.updateReservation = async (req, res) => {
  try {
    ...
    // Na7i lkhata2 ken fama problème mta3 les places
...
// 3ala5ater l'affichage mta3 les films
...
// 3ala5ater l'affichage mta3 les paiements
...
// 3ala5ater l'affichage mta3 les séances
...
exports.deleteSeance = async (req, res) => {
  try {
    // Na7i lkhata2 ken fama réservations
